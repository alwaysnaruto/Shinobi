...
PM_START_TEXT = """
😁 𝐇𝐞𝐥𝐥𝐨, 𝐭𝐡𝐞𝐫𝐞! 𝐈'𝐦  [sʜɪɴᴏʙɪ](https://telegra.ph/file/a0effec1119e0b96b6a44.jpg)  - 𝐀 𝐁𝐨𝐭 𝐖𝐡𝐢𝐜𝐡 𝐖𝐢𝐥𝐥 𝐇𝐞𝐥𝐩 𝐘𝐨𝐮 𝐓𝐨 𝐌𝐚𝐧𝐚𝐠𝐞 𝐘𝐨𝐮𝐫 𝐆𝐫𝐨𝐮𝐩𝐬 𝐀𝐭 𝐀 𝐓𝐫𝐞𝐦𝐞𝐧𝐝𝐨𝐮𝐬 𝐏𝐚𝐜𝐞!!

👍 𝑻𝒚𝒑𝒆 /help 𝑻𝒐 𝑭𝒊𝒏𝒅 𝑶𝒖𝒕 𝑪𝒐𝒎𝒑𝒍𝒆𝒕𝒆𝒍𝒚 𝑯𝒐𝒘 𝑰 𝑾𝒐𝒓𝒌!!"""
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text="Sᴜᴘᴘᴏʀᴛ Cʜᴀᴛ 📢 ",
                            url="https://t.me/TheShinobi_Support".format(SUPPORT_CHAT),
                        )
                    ],
                ]
            ),
